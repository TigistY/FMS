                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                           ...
                           <small class="badge border 
                              {{ $feedback->feedback_type == 'Positive' ? 'bg-success text-white' : 
                                ($feedback->feedback_type == 'Neutral' ? 'bg-info text-white' : 
                               ($feedback->feedback_type == 'Negative' ? 'bg-danger text-white' : 'bg-light  text-dark')) }}" 
