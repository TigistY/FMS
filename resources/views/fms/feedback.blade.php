                ...
                <div class="card p-4 shadow-lg border-0 feedback-theme">
                    ...
                    <form action="{{ route('feedback.submit') }}" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            {{-- 2. College Filter (Only for Department) --}}
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="form-text text-primary d-none" id="loading-text"></small>
                            </div>
                        </div>
                        ...
                        <button type="submit" id="button-submit" class="btn btn-primary w-100 mt-4 py-2 fw-bold">
